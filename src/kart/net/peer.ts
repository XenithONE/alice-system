/**
 * WebRTC transport over PeerJS — the same arrangement VORTEX CROWN ships.
 *
 * The room code IS the host's peer id, so joining needs nothing but the six
 * characters. PeerJS is loaded on demand: a solo race must not pay for it.
 */
